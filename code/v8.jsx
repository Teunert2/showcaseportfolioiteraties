...
export default function Upendo() {
  ...
  const handleBack = () => {
    ...
    overlay.style.transition =
      "all 0.8s cubic-bezier(0.645, 0.045, 0.355, 1.000)";
    ...
    setTimeout(() => {
      ...
      rocket.style.transform =
        "translate(calc(-100vw - 150px), calc(100vh + 150px)) rotate(220deg)";
    }, 50);
  ...
  return (
    <div className="min-h-screen p-8 md:p-16 relative">
      <button onClick={handleBack} className="fixed top-8 right-8 z-20 group">
        ...
        <div className="grid grid-cols-2 gap-16 mt-16">
          <div className="space-y-8">
            <div className="font-objectivity">
              ...
              <p className="text-lg">
                Upendo is een innovatief data-analytics platform ontwikkeld voor
                2manydots. Het project maakt bedrijfsdata toegankelijk en
                inzichtelijk zonder complexiteit. Met vijf kernonderdelen -
                Configuratie, Optimalisaties, Visualisatie, Analyse en Training
                - bieden we een oplossing voor datavraagstukken. Als
                ontwikkelaar heb ik bijgedragen aan verschillende service
